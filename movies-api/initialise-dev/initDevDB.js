...
import Favourites from "../api/favourites/favouriteModel";
...
async function main() {
    ...
    await Favourites.collection.drop().catch(err => console.log('Movie collection not found'));
    ...
    console.log(`${favourites.length} movies loaded`);
